  ...
  <div class="head_nav">
    ...
    <div class="w960">
      <ul>
        ...
        <li><a href="<%=request.getContextPath()%>/findmyfriend" >好友</a></li>
      </ul>
      <div class="head-avatar">
	  <a href="<%=path %>/jsp/updateheadpic.jsp" target="iframepage"><img src="static/headpic/${sessionScope.user.headpic}" alt=""/></a>
      </div>
    </div>
  </div>
</div>
